...
import { Alert, AlertIcon, AlertTitle, Box, Button, Image, Input, Link, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Text, useColorMode } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Button onClick={(_e) => addEvents([Event("state.auth_state.login", {})], (_e))} sx={{"bg": "blue.500", "color": "white", "_hover": {"bg": "blue.600"}, "mb": 4}}>
  {`Log in`}
</Button>
</Box>
  <Fragment>
  {isTrue(state.auth_state.is_registered) ? (
  <Fragment>
  <Alert status={`success`} sx={{"maxWidth": "400px", "margin": "auto"}}>
  <AlertIcon/>
  <AlertTitle>
